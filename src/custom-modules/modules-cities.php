<?php if('cities_module' === get_row_layout()): ?>
  <section class="CitiesModule">
    <div class="Container--large">
      <div class="Container">
        <div class="CitiesHeader SectionHeader">
          <hr class="TextRule">
          <div class="Cities__header"><h3>Get hired faster with VanHack's global reach</h3></div>
          <div class="Cities__subtitle">Get access to professional development, english practice, and more to help you land your dream job.</div>
        </div>
      </div>
