<?php if('pricing_module' === get_row_layout() ): ?>
      ...
      <div class="PricingCard">
        ...
        <div class="PricingCard__body">
          ...
          <ul class="PricingCard__list">
            <li class="PricingCard__item">Access to jobs that will sponsor your visa</li>
            <li class="PricingCard__item"> Video course about getting a job abroad</li>
            <li class="PricingCard__item">Newsletter with the latest tips about getting hired abroad</li>
          </ul>
        </div>
        <div class="PricingCard__footer">
          <div class="PricingCard__footer">
            <a href="http://app.vanhack.com/Account/Register" class="PricingCard__button ButtonPrimary">Join VanHack</a>
